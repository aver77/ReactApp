...
export default class PostListItem extends React.Component {
    constructor(props) { //данные пропс из postlist записаны
        super(props); //данные пропс из postlist записаны
        this.state = {
            important: false,
            like: false,
            del: false
    ...
    render() {
        const {label,onDelete} = this.props; //св-во, которое приходит в каждый новосозданный компонент this.props (app->postlist->postlistitem)
        ...
        return (
            <div className={classNames}>
                <span className="app-list-item-label" onClick={
                    this.onLike}>
                    {label}
                </span>
